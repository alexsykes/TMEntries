...
<div class="">This email is to let you know that only five spaces remain before the entry limit for this trial is reached. Please note that entries on TrialMonster are only confirmed when payment is received. When the entry limit is reached, any unconfrmed entries will be added to the Resreve Entrants list.</div>
