<x-club>
    <x-slot:heading>Editing Distribution List - {{$listItem->name}}</x-slot:heading>
    <form action="/club/distribution/update" method="POST">
        @csrf
        @method('PATCH')
        <input type="hidden" name="itemID" value="{{$listItem->id}}" id="itemID">
        <div class=" bg-white border-1 border-gray-400 rounded-xl  outline outline-1 -outline-offset-1 drop-shadow-lg outline-gray-300 pb-2">
            ...
            <div class="grid mt-2 gap-4 px-4">
                <x-form-field>
                    <x-form-label for="name">Name</x-form-label>
                    <div class="mt-2 col-span-2">
                        <x-form-input name="name" type="text" id="name" value="{{$listItem->name}}"
                ...
                <x-form-field>
                    ...
                    <div class="mt-2 col-span-2">
                        <x-form-input name="description" type="text" id="description" value="{{$listItem->description}}"
