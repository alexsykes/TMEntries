<x-club>
    ...
    <div>
        ...
        <div id="{{$category}}" class="tabcontent pt-0 ">
            <div
                class=" bg-white border-1 border-gray-400 rounded-xl  outline outline-1 -outline-offset-1 drop-shadow-lg outline-gray-300 pb-2">
                <div>
                    <div
                        class="flex justify-between font-bold w-full mt-0 pt-2 pb-2 pl-2 pr-4 rounded-t-xl  text-white bg-violet-600">{{$category}}</div>
    ...
    @if(sizeof($mailshotData) > 0)
        <div class="mt-4">
            <div
                ...
                <div>
                    <div
                        class="flex justify-between font-bold w-full mt-0 pt-2 pb-2 pl-2 pr-4 rounded-t-xl  text-white bg-violet-600">
                        Scheduled Mailshots
                    </div>
                    <table class="overflow-y-auto w-full text-sm">
