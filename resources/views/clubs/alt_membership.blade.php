<x-main>
    ...
    @endphp
    <form id="registerForm" action="/club/member/add" method="POST">
        @csrf
        ...
        <div id="buttons" class="py-4 px-4">
            ...
            <button type="submit"
                    class="g-recaptcha rounded-md ml-2 bg-blue-600 px-3 py-1 text-sm font-light  border border-blue-800 text-white drop-shadow-lg hover:bg-blue-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
                    data-sitekey="{{ config('services.recaptcha_v3.siteKey') }}"
                    data-callback="onSubmit"
                    data-action="register">
                Register
            </button>
            {{--            <button class="g-recaptcha  rounded-md ml-2 bg-blue-600 px-3 py-1 text-sm font-light  border border-blue-800 text-white drop-shadow-lg hover:bg-blue-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"--}}
            {{--                                                   data-sitekey="{{ config('services.recaptcha_v3.siteKey') }}"--}}
            {{--                                                   data-callback="onSubmit"--}}
            {{--                                                   data-action="register">Register--}}
            {{--            </button>--}}
        </div>
    </form>
