        ...
        <div class="grid grid-cols-2 gap-4 px-4">
            <x-form-field>
                ...
                <div class="mt-2 col-span-2">
                    <x-form-input name="name" type="text" id="name" value="{{$venue->name}}"
            ...
            <x-form-field>
                ...
                <div class="mt-2 col-span-2">
                    <x-form-input name="landowner" type="text" id="landowner" value="{{$venue->landowner}}"
            ...
            <x-form-field>
                ...
                <div class="mt-2 col-span-2">
                    <x-form-input name="address" type="text" id="address" value="{{$venue->address}}"
            ...
            <x-form-field>
                ...
                <div class="mt-2 col-span-2">
                    <x-form-input name="postcode" type="text" id="postcode" value="{{$venue->postcode}}"
            ...
            <x-form-field>
                ...
                <div class="mt-2 col-span-2">
                    <x-form-input name="w3w" type="text" id="w3w" value="{{$venue->w3w}}"
            ...
            <x-form-field>
                ...
                <div class="mt-2 col-span-2">
                    <x-form-input name="phone" type="text" id="phone" value="{{$venue->phone}}"
                                  placeholder="Postcode" required/>
            ...
            <x-form-field>
                ...
                <div class="mt-2 col-span-2">
                    <x-form-input name="club" type="text" id="club" value="{{$venue->club}}"
            ...
            <x-form-field>
                ...
                <div class="mt-2 col-span-2">
                    <x-form-input name="centre" type="text" id="centre" value="{{$venue->centre}}"
            ...
            <x-form-field>
                ...
                <div class="mt-2 col-span-2">
                    <x-form-input name="latitude" type="text" id="latitude" value="{{$venue->latitude}}"
                                  placeholder="Postcode" required/>
            ...
            <x-form-field>
                ...
                <div class="mt-2 col-span-2">
                    <x-form-input name="longitude" type="text" id="longitude" value="{{$venue->longitude}}"
                                  placeholder="Postcode" required/>
                ...
                <x-form-field>
                    ...
                    <div class="mt-2 ">
                        <textarea  class="withEditor"  name="directions" type="text" id="directions" >{{$venue->directions}}</textarea>
                    </div>
                    @error('directions')
                    <p class="text-xs text-red-500 font-semibold mt-1">{{ $message }}</p>
                    @enderror
                ...
                <x-form-field>
                    ...
                    <div class="mt-2 ">
                        <textarea  class="withEditor"  name="notes" type="text" id="notes" >{{$venue->notes}}</textarea>
                    </div>
                    @error('notes')
                    <p class="text-xs text-red-500 font-semibold mt-1">{{ $message }}</p>
                    @enderror
