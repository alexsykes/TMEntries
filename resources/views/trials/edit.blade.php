...
//    dd($savedEntryMethods);
    ...
    @endif
    <div class="tab pl-8">
        <button class="tablinks border border-black border-b-0 rounded-t-lg   hover:bg-violet-500 p-2" id="defaultOpen"
                onclick="openSection(event, 'Details')">Detail
        </button>
        <button class="tablinks border border-black border-b-0 rounded-t-lg    hover:bg-violet-500 p-2  "
    ...
    <form action="/trials/update" method="POST">
        ...
        <div id="Details" class="tabcontent pt-0 ">
            ...
            <input type="hidden" value="{{$trial->extras}}" name="extras">
            <div class="space-y-2">
                    ...
                    <div class=" grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                        ...
                        <div id="numDaysDiv" class=" col-span-full">
                            <x-form-field id="" name="" class="">
                                ...
                                <div class="mt-2 col-span-2">
                                    <x-form-input name="numDays" type="number" id="numDays" value="{{$trial->numDays}}"
                                                  min="1"/>
                        ...
                        <x-form-field>
                            ...
                            <div class="mt-2 col-span-2">
                                <x-form-input name="startTime" type="text" id="startTime"
                                              placeholder="Trial starting time" value="{{$trial->startTime}}" required/>
                        ...
                        <x-form-field>
                            ...
                            <div class="mt-2 col-span-2">
                                <x-form-input name="contactName" type="text" id="contactName  "
                                              placeholder="Contact name" value="{{$trial->contactName}}" required/>
                        ...
                        <x-form-field class="mt-2 col-span-2 sm:col-span-3">
                            ...
                            <div class="flex mt-2 rounded-md shadow-sm ring-1 ring-inset outline outline-1 -outline-offset-1 drop-shadow-lg outline-violet-700 focus-within:ring-2  focus-within:ring-inset focus-within:ring-violet-600 sm:max-w-md">
                                <select class="border-0  pl-2 pt-2  bg-transparent pb-1 space-x-4 " name="venueID"
                                        id="venueID">
                                    <option value="0">Other</option>
                                    @foreach($venues as $venue)
                                        <option
                                                <?php if ($trial->venueID == $venue->id) { ?> selected="selected"
                                                <?php } ?>
                        ...
                        <x-form-field>
                            ...
                            <div class="mt-2 col-span-2">
                                <x-form-input name="otherVenue" type="text" id="otherVenue"
                                              value="{{$trial->otherVenue}}" placeholder="Venue name"/>
        ...
        <div id="Trial" class="tabcontent pt-0">
            <div class="space-y-2">
                <div class="px-4 py-4 mt-0 bg-white border-1 border-gray-400 rounded-xl  outline outline-1 -outline-offset-1 drop-shadow-lg outline-gray-300">
                    <div class="text-violet-700 font-semibold mb-4">Please list the Courses and Classes in the order in
                        which you would like them to appear in the results. Courses/classes in each list should be
                        separated by commas.
                    </div>
                    <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                                ...
                                <div class="pl-2 pr-0">
                                    @foreach($entryMethodArray as $entryMethod)
                                        <div>
                                            <input
                                                    <?php
                                                if (in_array($entryMethod, $savedEntryMethods)) {
                                                    echo ' checked';
                                                } ?>

                                            name="entryMethod[]" type="checkbox" id="entryMethod[]"
                                                    value="{{$entryMethod}}"/>
                                ...
                                <div class="mt-2 col-span-2">
                                    ...
                                    @foreach($entrySelectionArray as $option)
                                        <input name="entrySelectionBasis"
                                               <?php if ($option == $trial->entrySelectionBasis) { ?>checked="checked"
                                               <?php } ?>
                                               type="radio"
                            ...
                            <x-form-field>
                                ...
                                <div class="mt-2">
                                    <input
                                            ...
                                            name="hasOpeningDate" type="checkbox" value="1" id="hasOpeningDate">
                                    <x-form-error name="openingDate"/>
                                </div>
                            ...
                            <x-form-field>
                                ...
                                <div class="mt-2 col-span-2">
                                    <x-form-input name="openingDate" type="datetime-local" min="{{date('Y-m-d')}}"
                                                  id="openingDate" value="{{$trial->openingDate}}"/>
                                    <x-form-error name="openingDate"/>
                                </div>
                                @error('date')
                                <p class="text-xs text-red-500 font-semibold mt-1">{{ $message }}</p>
                            ...
                            <x-form-field>
                                ...
                                <div class="mt-2 col-span-2">
                                    <x-form-input name="closingDate" type="datetime-local" min="{{date('Y-m-d')}}"
                                                  id="closingDate" value="{{$trial->closingDate}}"/>
                                ...
                                <div class="mt-2">
                                    @foreach($scoringModeArray as $option)
                                        <input name="scoringMode"
                                               <?php if ($option == $trial->scoringMode) { ?>checked="checked"
                                               <?php } ?>
                                ...
                                <div class="mt-2 col-span-3">
                                    @foreach($stopAllowedArray as $option)
                                        <input name="stopNonStop"
                                               <?php if ($option == $trial->stopNonStop) { ?>checked="checked"
                                               <?php } ?>
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                        ...
                        <div id="notesDiv" class="mt-2 col-span-full">
                            <x-form-field>
                                ...
                                <div class="mt-2 ">
                                    <textarea class="withEditor" name="notes" type="text"
                                              id="notes">{{$trial->notes}}</textarea>
                                </div>
                                @error('notes')
                                <p class="text-xs text-red-500 font-semibold mt-1">{{ $message }}</p>
                                @enderror
            ...
            <div class="space-y-12">
                <div class="px-4 py-4 mt-0 bg-white border-1 border-gray-400 rounded-xl  outline outline-1 -outline-offset-1 drop-shadow-lg outline-gray-300">
                    <div class="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                        ...
                        <div class="text-violet-800 font-semibold col-span-full">Additional items for purchase such as
