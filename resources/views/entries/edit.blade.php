        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                        ...
                        <x-form-field>
                            ...
                            <div class="mt-2 col-span-2">
                                <x-form-input name="name" type="text" id="name" value="{{$selected_name}}"  placeholder="Rider's name" required />
                        ...
                        <x-form-field>
                            ...
                            <div class="mt-2 col-span-2">
                                <x-form-input name="licence" type="text" id="licence" value="{{$selected_licence}}" placeholder="Licence number - leave blank if no licence"   />
                        ...
                        <x-form-field>
                            ...
                            <div class="ml-2 mt-2 col-span-full">
                                <input type="checkbox" name="isYouth" id="isYouth" value="1" {{$isYouthCB}} class="isYouth"  onchange="toggle(checked)"/>
                        ...
                        <x-form-field>
                            ...
                            <div class="mt-2 col-span-2">
                                <x-form-input name="make" type="text" id="make" value="{{$selected_make}}" placeholder="Bike make/model" required />
                        ...
                        <x-form-field>
                            ...
                            <div class="mt-2">
                                <x-form-input name="size" type="text" id="size" value="{{$selected_size}}" placeholder="Bike engine size - leave empty for e-Bike"  />
                ...
                <div class="mt-4" id="buttons">
                    <a href="/entries/userdata"  class="rounded-md bg-white px-3 py-2 text-sm  text-blue-600 shadow-sm hover:bg-blue-900 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-900">Cancel</a>

                    <button type="submit" class="rounded-md ml-2 bg-blue-600 px-3 py-1 text-sm font-light  border border-blue-800 text-white drop-shadow-lg hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Save</button>
                </div>
            </div>
        </div>
    </form>
