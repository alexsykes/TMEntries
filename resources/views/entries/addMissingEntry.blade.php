...
//    $userID = Auth::user()->id;
    ...
    <form action="/entries/addMissingEntry" method="POST">
        @csrf
        <input type="hidden" id="trial_id" name="trial_id" value="{{$id}}">
                    ...
                    <div class="mt-2 px-2 py-2 pb-4 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                        <x-form-field>
                            ...
                            <div class="mt-2 col-span-2">
                                <x-form-input name="number" type="text" id="number" :value="old('number')" required
                                              placeholder="Riding number"
                                />
