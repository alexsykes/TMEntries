...
<nav class="relative bg-violet-800 dark:bg-violet-800/50 dark:after:pointer-events-none dark:after:absolute dark:after:inset-x-0 dark:after:bottom-0 dark:after:h-px dark:after:bg-white/10">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                {{--                <button type="button"--}}
                {{--                        class="relative rounded-full p-1 text-gray-400 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500 dark:hover:text-white">--}}
                ...
                {{--                             alt=""--}}
                {{--                             class="size-8 rounded-full bg-violet-800 outline outline-1 -outline-offset-1 outline-white/10"/>--}}
                {{--                    </button>--}}

                {{--                    <el-menu anchor="bottom end" popover--}}
                {{--                             class="m-0 w-48 origin-top-right rounded-md bg-white p-0 py-1 shadow-lg outline outline-1 outline-black/5 transition [--anchor-gap:theme(spacing.2)] [transition-behavior:allow-discrete] data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[leave]:duration-75 data-[enter]:ease-out data-[leave]:ease-in dark:bg-violet-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">--}}
                {{--                        <a href="#"--}}
                {{--                           class="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:outline-none dark:text-gray-300 dark:focus:bg-white/5">Your--}}
                {{--                            profile</a>--}}
                {{--                        <a href="#"--}}
                {{--                           class="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:outline-none dark:text-gray-300 dark:focus:bg-white/5">Settings</a>--}}
                {{--                        <a href="#"--}}
                {{--                           class="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:outline-none dark:text-gray-300 dark:focus:bg-white/5">Sign--}}
                {{--                            out</a>--}}
                {{--                    </el-menu>--}}
                {{--                </el-dropdown>--}}
            </div>
    ...
    <el-disclosure id="mobile-menu" hidden class="sm:hidden [&:not([hidden])]:block">
        <div class="space-y-1 px-2 pb-3 pt-2">
            <!-- Current: "bg-gray-900 dark:bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
            <a href="#" aria-current="page"
               class="block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white dark:bg-gray-950/50">Dashboooard</a>
            <a href="#"
