...
<div class="w-full  lg:max-w-4xl max-w-[335px]">
    <form method="POST" name="contactForm" id="contactForm" action="/contact/submit">
        ...
        <div>
            ...
            <input class="p-1 rounded-md    border-blue-700 border bg-white" type="text" id="name" name="name" required placeholder="Your name…"><br>
        </div>
        <div class="mt-2">
            <label class="font-semibold  text-blue-700" for="email">Email:</label><br>
            <input class="p-1 rounded-md border-blue-700 border bg-white" type="email" id="email" name="email" placeholder="Your email address…" required><br>
        </div>
        <div class="mt-2">
            <label  class="font-semibold text-blue-700 " for="message">Message:</label><br>
